        ...
        <div className="max-w-8xl mx-auto">
          ...
          >
            ...
            >
                ...
                <div className={clsx("flex")}>
                  ...
                  >
                    <div className="flex flex-row gap-4">
                      ...
                      <Button className="bg-gradient-to-r bg-[#d40029] hover:bg-[#d40029] text-white transition-all duration-300 transform hover:scale-105">
              ...
              <div className="pt-2 ">
                {messages?.length > 0 && (
                  <div className="rounded-ss-md rounded-se-md bg-gradient-to-r bg-[#d40029] p-3 flex items-center justify-between gap-2">
                  ...
                  >
                                    ...
                                    {message?.suggestion?.map(
                                      (product, index) => (
                                        <Card
                                          ...
                                          className="bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full flex flex-col overflow-hidden border border-gray-200 dark:border-gray-700"
                                        >
                                          <CardHeader className="p-2 bg-gradient-to-r bg-[#d40029]">
                                            <div className="flex justify-between items-start">
                                              <CardTitle className="text-sm font-bold text-white truncate max-w-full">
                                                {product.name
                                                  .charAt(0)
                    ...
                    >
                      ...
                      <Button
                        type="submit"
                        disabled={loading || isTyping}
                        className="bg-gradient-to-r bg-[#d40029] hover:bg-[#d40029] text-white transition-all duration-300 transform hover:scale-105"
                      >
              ...
              >
                <div>
                  ...
                  <p className="text-sm font-light tracking-wider text-gray-600 dark:text-gray-400">
                    ...
                    Mfr #{" "}
                    <span className="uppercase">{product?.mfr_number}</span>
                  </p>
                ...
                <div>
                  ...
                  >
                    ...
                    <Button
                      variant="outline"
                      className="border-[#d40029] text-[#d40029] hover:bg-blue-100 dark:border-blue-500 dark:text-blue-300 dark:hover:bg-blue-900 transition-all duration-300 transform hover:scale-105"
                    >
                      <Heart className="mr-2 h-4 w-4" /> Save for Later
                    </Button>
                  </div>
