    ...
    <>
      <header className="shadow-lg bg-white fixed top-0 right-0 left-0 z-50">
        ...
        <div className="p-2 flex flex-col sm:flex-row items-center justify-between">
          ...
          {/* Desktop Search */}
          <div className="hidden sm:flex md:flex xl:flex items-center h-10 bg-gradient-to-r bg-[#d40029] rounded-full cursor-pointer mx-2 flex-grow max-w-3xl shadow-md">
            <input
          ...
          <div className="flex items-center space-x-6 mx-2 text-black">
            ...
            <div className="hidden relative link sm:flex items-center space-x-1 p-2 rounded-full hover:bg-primary-light cursor-pointer transition-colors">
              ...
              {/* Cart Badge */}
              <span className="absolute bg-gradient-to-r bg-[#d40029] -top-1 -right-1 h-5 w-5  text-center text-xs text-white rounded-full flex items-center justify-center">
                2
              </span>
            </div>
          </div>
        ...
        <div className="px-4 text-sm shadow-md bg-gradient-to-r bg-[#d40029] fixed w-full h-8 flex items-center gap-2 text-white">
          {/* <div>Top Brands</div> */}
        </div>
      </header>
    </>
